...
INSERT into categoria (Cod_categoria,Nome_categoria,descricao) 
VALUES (4,'Dairy Products','Queijos');
...
--deletando uma palavras da tabela 
DELETE from Categoria where Descricao like 'Queijos'
...
--ele vai deletar tudo	que é null na tabela 
